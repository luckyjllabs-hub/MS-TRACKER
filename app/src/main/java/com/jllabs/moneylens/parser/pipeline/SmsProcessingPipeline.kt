...
import com.jllabs.moneylens.parser.stage5.*
import com.jllabs.moneylens.parser.stage6.SmsCategory
import com.jllabs.moneylens.parser.stage7.ConfidenceCalculator
...
object SmsProcessingPipeline {
    ...
    fun process(
        ...
        val availableBalance = BalanceParser.extractDisplayBalanceMinor(body)
        ...
        val isMerchantKnown = com.jllabs.moneylens.parser.classifier.MerchantNormalizer.isKnownMerchant(merchant)
