package com.jllabs.moneylens.parser.stage1
...
object MessageTypeClassifier {
    ...
    private val FINANCIAL_KEYWORDS = setOf(
        "debited", "credited", "credit by", "has a credit", "withdrawn", "deposited", "paid",
        "received", "transferred", "spent", "purchase", "payment", "transaction", "txn",
        "upi", "neft", "rtgs", "imps", "atm", "pos", "emi", "mandate", "auto-debit", "fastag"
    )
    ...
    fun classify(sender: String, body: String): MessageType {
        ...
        if (com.jllabs.moneylens.parser.stage3.NonTransactionAlertFilter.isNonTransactionAlert(body)) {
