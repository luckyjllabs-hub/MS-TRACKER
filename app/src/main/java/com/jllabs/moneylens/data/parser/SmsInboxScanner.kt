...
object SmsInboxScanner {
    ...
    private val TRANSACTION_KEYWORDS = listOf(
        "debited", "credited", "spent", "sent", "paid", "received", "withdrawn", "txn", "transfer",
        "inr", "rs.", "rs ", "₹",
        "due", "emi", "loan", "passbook", "contribution", "avl bal", "avbl bal", "available balance",
        "unclaimed balance", "avl limit", "deposited", "amt deducted",
        "fastag", "toll", "kyc", "a/c", "acct", "credit by", "cheque"
    )
