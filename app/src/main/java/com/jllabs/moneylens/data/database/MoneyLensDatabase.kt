package com.jllabs.moneylens.data.database
...
import com.jllabs.moneylens.data.database.migrations.Migrations
...
abstract class MoneyLensDatabase : RoomDatabase() {
    ...
    companion object {
        @Volatile
        private var INSTANCE: MoneyLensDatabase? = null

        fun getDatabase(context: Context): MoneyLensDatabase {
        ...
        private class DatabaseCallback(private val context: Context) : RoomDatabase.Callback() {
            ...
            private suspend fun seedDatabase(db: MoneyLensDatabase) {
                // Seed Accounts
