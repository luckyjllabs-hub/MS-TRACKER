...
object FinancialFilter {
    ...
    private val FINANCIAL_SENDER_PATTERNS = Regex(
        """(?i)(?:HDFC|ICICI|ICICIT|CBSSBI|SBI|AXIS|KOTAK|YESBNK|YESBK|PNB|BOB|CANBNK|IDFC|RBL|INDUS|INDUSB|CITI|CITIBK|FEDERAL|UNION|UNIONB|CENTRAL|PAYTM|PHONEPE|PHONPE|PHSTPA|GPAY|CRED|AMAZON|AMZN|QCAMZN|MOBIKW|NPSTXN|PINE)"""
    )
