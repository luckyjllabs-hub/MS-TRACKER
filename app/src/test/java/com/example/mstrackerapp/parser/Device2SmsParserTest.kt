package com.example.mstrackerapp.parser
...
import com.example.mstrackerapp.parser.stage5.MerchantExtractor
...
class Device2SmsParserTest {
    ...
    fun testHdfcCardPaymentCreditedToCardNotIncome() {
        ...
        assertEquals(TransactionType.EXPENSE, dc.transactionType)
        assertEquals(com.example.mstrackerapp.domain.models.SmsTransactionSubType.CARD_BILL_PAYMENT, dc.subType)
    }
}
